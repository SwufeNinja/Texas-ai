  ...
  data() {
    return {
      ...
      seatPositions: [
        ...
        { top: "18%", left: "72%", transform: "translate(-50%, -50%)" },
        { top: "30%", left: "84%", transform: "translate(-50%, -50%)" },
        { top: "66%", left: "82%", transform: "translate(-50%, -50%)" },
        { top: "84%", left: "50%", transform: "translate(-50%, -50%)" },
        { top: "66%", left: "18%", transform: "translate(-50%, -50%)" },
        { top: "30%", left: "16%", transform: "translate(-50%, -50%)" },
        { top: "18%", left: "28%", transform: "translate(-50%, -50%)" },
